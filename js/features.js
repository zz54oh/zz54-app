...
window.clearDgHeaderBg = function () {
    ...
    // 隐藏预览图
    var previewDiv = document.getElementById('dg-header-bg-preview');
...
window.switchToAnnouncementPanel = function () {
    ...
    renderAnnStatusPool();
    var savedBg = localStorage.getItem('dg_header_bg');
    var previewImg = document.getElementById('dg-header-bg-preview-img');
    var previewDiv = document.getElementById('dg-header-bg-preview');
